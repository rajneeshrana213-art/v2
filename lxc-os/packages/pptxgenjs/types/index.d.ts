...
declare namespace PptxGenJS {
	...
	export interface DataOrPathProps {
		 ...
		 * @example '/home/rajneeshrana0/rit/images/myimg.png` // retrieve image via local path
		 */
		path?: string
		/**
	...
	export interface ShapeProps extends PositionProps, ObjectNameProps {
		 ...
		 * @example hyperlink: { url: "https://github.com/rajneeshrana0/rit/pptxgenjs", tooltip: "Visit Homepage" },
		 */
		hyperlink?: HyperlinkProps
		/**
		 * Line options
	...
	export interface TableToSlidesProps extends TableProps {
		 ...
		 * - range: -1.0 to 1.0
		 * @see 		 * @docs rajneeshrana0/ritapi-tables.html
		 * @default 0.0
		 ...
		 * @see 		 * @docs rajneeshrana0/ritmasters.html
		 */
	...
	*/
	...
	export interface PresSlide {
		 ...
		 * @example { path: '/home/rajneeshrana0/rit/images/myimg.png` } - retrieve image via local path
	...
	export class Slide {
		 ...
		 * @docs 		 * @docs rajneeshrana0/ritspeaker-notes.html
