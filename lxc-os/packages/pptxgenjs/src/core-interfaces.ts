...
export interface ShapeProps extends PositionProps, ObjectNameProps {
	 ...
	 * @example hyperlink: { url: "https://github.com/rajneeshrana0/rit", tooltip: "Visit Homepage" },
	 */
	hyperlink?: HyperlinkProps
	/**
	 * Line options
...
export interface TableToSlidesProps extends TableProps {
	 ...
	 * - range: -1.0 to 1.0
	 * @see https://rajneeshrana0/rit.github.io/PptxGenJS/docs/api-tables.html
	 * @default 0.0
	 ...
	 * @see https://rajneeshrana0/rit.github.io/PptxGenJS/docs/masters.html
	 */
