...
export async function generateFullScenes(
  ...
  callbacks?.onProgress?.({
    ...
    overallProgress: 66,
    stageProgress: 0,
    statusMessage: `${totalScenes} दृश्य समानांतर रूप से तैयार किए जा रहे हैं...`,
    scenesGenerated: 0,
    totalScenes,
  });
    ...
    sceneOutlines.map(async (outline, index) => {
      try {
        ...
        callbacks?.onProgress?.({
          ...
          statusMessage: `${completedCount}/${totalScenes} दृश्य पूर्ण हो गए`,
...
async function generateSlideContent(
  ...
  const prompts = buildPrompt(PROMPT_IDS.SLIDE_CONTENT, {
    ...
    elements: '(मुख्य बिंदुओं के आधार पर स्वतः तैयार किया गया)',
  ...
  return [
    {
      id: `action_${nanoid(8)}`,
      type: 'speech',
      title: 'PBL परियोजना परिचय',
      text: 'अब हम एक परियोजना-आधारित शिक्षा गतिविधि शुरू करते हैं। अपनी भूमिका चुनें, कार्य-बोर्ड देखें और मिलकर परियोजना पूरी करें।',
    },
  ];
}
...
function generateDefaultSlideActions(outline: SceneOutline, elements: PPTElement[]): Action[] {
  ...
  if (textElements.length > 0) {
    actions.push({
      id: `action_${nanoid(8)}`,
      type: 'spotlight',
      title: 'मुख्य बिंदु पर ध्यान दें',
  ...
  return [
    {
      id: `action_${nanoid(8)}`,
      type: 'speech',
      title: 'प्रश्नोत्तरी मार्गदर्शन',
      text: 'अब हम एक छोटी प्रश्नोत्तरी करते हैं जिससे आपकी सीखने की प्रगति का मूल्यांकन हो सके।',
    },
  ];
}
  ...
  return [
    {
      id: `action_${nanoid(8)}`,
      type: 'speech',
      title: 'संवादात्मक मार्गदर्शन',
      text: 'अब हम इंटरएक्टिव विज़ुअलाइज़ेशन के माध्यम से इस अवधारणा को एक्सप्लोर करते हैं। पृष्ठ के तत्वों को संचालित करके परिवर्तन देखें।',
    },
  ];
}
