  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold">दृश्य रूपरेखा</h2>
          <p className="text-sm text-muted-foreground">
            कुल {outlines.length} दृश्य — संपादित, जोड़ें, हटाएँ या पुनः क्रमबद्ध करें
          </p>
        </div>
          ...
          <Card key={outline.id} className="relative">
            <CardHeader className="pb-3">
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="slide">स्लाइड</SelectItem>
                    <SelectItem value="quiz">प्रश्नोत्तरी</SelectItem>
                  </SelectContent>
                </Select>
                <Button
                  variant="ghost"
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label>दृश्य विवरण</Label>
                <Textarea
                  value={outline.description}
                  onChange={(e) => updateOutline(index, { description: e.target.value })}
                  placeholder="इस दृश्य के उद्देश्य और सामग्री का संक्षिप्त विवरण दें"
                  rows={2}
                  disabled={isLoading}
                />
              </div>
              ...
              <div className="space-y-2">
                <Label>मुख्य बिंदु (प्रत्येक पंक्ति में एक)</Label>
                <Textarea
                  value={outline.keyPoints?.join('\n') || ''}
                  onChange={(e) => updateKeyPoints(index, e.target.value)}
                  placeholder="मुख्य बिंदु दर्ज करें, प्रत्येक पंक्ति में एक"
                  rows={3}
                  disabled={isLoading}
                />
              </div>
              ...
              {outline.type === 'quiz' && (
                <div className="p-3 bg-muted/50 rounded-lg space-y-3">
                  <Label className="text-sm font-medium">प्रश्नोत्तरी सेटअप</Label>
                  <div className="grid grid-cols-3 gap-3">
                    <div className="space-y-1">
                      <Label className="text-xs">प्रश्नों की संख्या</Label>
                      <Input
                        type="number"
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs">कठिनाई स्तर</Label>
                      <Select
                    ...
                    <div className="space-y-1">
                      <Label className="text-xs">प्रश्न का प्रकार</Label>
                      <Select
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="single">एकल विकल्प</SelectItem>
                          <SelectItem value="multiple">बहु विकल्प</SelectItem>
                          <SelectItem value="text">संक्षिप्त उत्तर</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
      ...
      {outlines.length === 0 && (
        <Card className="p-8 text-center">
          <p className="text-muted-foreground mb-4">अभी कोई दृश्य रूपरेखा नहीं है</p>
          <Button variant="outline" onClick={addOutline} disabled={isLoading}>
            <Plus className="size-4 mr-1" />
            पहला दृश्य जोड़ें
          </Button>
      ...
      <div className="flex justify-between pt-4">
        <Button variant="outline" onClick={onBack} disabled={isLoading}>
          आवश्यकताएँ संपादित करें
        </Button>
        <Button onClick={onConfirm} disabled={isLoading || outlines.length === 0}>
          {isLoading ? 'तैयार हो रहा है...' : 'पुष्टि करें और पाठ्यक्रम बनाएँ'}
        </Button>
      </div>
    </div>
  );
