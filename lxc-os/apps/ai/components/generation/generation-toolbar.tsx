...
export interface GenerationToolbarProps {
  ...
  onLanguageChange: (lang: 'hi-IN' | 'en-US') => void;
  webSearch: boolean;
...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-blue-200/60 dark:border-blue-700/50 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300`;
        ...
        <PopoverTrigger asChild>
          {pdfFile ? (
            <button className={pillActive}>
              ...
              <span
                role="button"
                className="size-4 rounded-full inline-flex items-center justify-center hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors"
                onClick={(e) => {
                  e.stopPropagation();
          ...
          <PopoverContent align="start" className="w-64 p-3 space-y-3">
            ...
            >
              <Globe2
                className={cn(
                  'size-4 shrink-0',
                  webSearch ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground',
                )}
              />
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <span>{language === 'hi-IN' ? 'हिन्दी' : 'EN'}</span>
          </button>
        </TooltipTrigger>
          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                ...
                currentModelId && 'ring-blue-300 dark:ring-blue-700 bg-blue-50 dark:bg-blue-950/20',
              )}
            >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-blue-50/50 dark:bg-blue-950/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img
