...
interface HeaderProps {
  ...
  readonly academicOpen?: boolean;
  readonly onToggleAcademic?: () => void;
}

export function Header({ currentSceneTitle, academicOpen, onToggleAcademic }: HeaderProps) {
    ...
    <>
      <header className="h-20 px-8 flex items-center justify-between z-10 bg-transparent gap-4">
        ...
        <div className="flex items-center gap-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-md px-2 py-1.5 rounded-full border border-gray-100/50 dark:border-gray-700/50 shadow-sm shrink-0">
          {/* Academic Intelligence Toggle */}
          {onToggleAcademic && (
            <button
              onClick={onToggleAcademic}
              title="Academic Intelligence — परीक्षा, होमवर्क, पाठ साथी"
              className={cn(
