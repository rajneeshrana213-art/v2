...
export default function SuperAdminDemosPage() {
  return (
    <>
      <Head>
        <title>Demos & Meetings - SuperAdmin | LearnXChain</title>
      </Head>
        ...
        <div className="w-full mx-auto space-y-8 pb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">
                Schedule and manage all demos and meetings across the organization.
              </p>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-white/10 rounded-2xl p-12 shadow-sm">
            <div className="text-center">
              <MonitorPlay className="h-16 w-16 text-gray-300 mx-auto mb-4" />
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                Demos & Meetings
              </h2>
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                This page will display all scheduled demos and meetings. Coming soon!
              </p>
            </div>
          </div>
        </div>
