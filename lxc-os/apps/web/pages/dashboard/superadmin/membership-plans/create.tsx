...
export default function CreateMembershipPlanPage() {
    ...
    useEffect(() => {
        if (router.query.type && (router.query.type === 'PLATFORM' || router.query.type === 'RIT')) {
            setFormData(prev => ({ ...prev, planType: router.query.type as string }));
        }
    }, [router.query.type]);
        ...
        const createPromise = new Promise(async (resolve, reject) => {
            try {
                ...
                if (res.ok) {
                    ...
                    reject(new Error(data.message || 'Failed to create plan'));
                }
            } catch (error) {
                reject(error);
            }
    ...
    return (
        <DashboardLayout role="superadmin">
            <Head>
                <title>Create Membership Plan - LearnXChain</title>
            </Head>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            Define pricing and user limits for a new subscription plan
                        </p>
                    </div>
                </div>

                <div
                    className="bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-800 animate-fade-in"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex items-center justify-end gap-4 pt-6 mt-8 border-t border-gray-100 dark:border-gray-800">
                            ...
                            >
                                ...
                                {loading ? 'Creating Plan...' : 'Create Membership Plan'}
                            </button>
                        </div>
