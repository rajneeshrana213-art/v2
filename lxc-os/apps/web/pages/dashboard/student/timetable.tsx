...
export default function StudentTimetablePage() {
    ...
    useEffect(() => {
        const fetchSchedule = async () => {
            try {
                const res = await client.get("/v1/dashboard/student/timetable");
    ...
    return (
        <>
            <Head>
                <title>Weekly Timetable - LearnXChain</title>
            </Head>
                ...
                <div className="space-y-6 pb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Stay on track with your classes.</p>
                        </div>
                    </div>
