...
export default function TeacherDetailedAttendance() {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const res = await client.get(`/v1/admin/dashboard/attendance/teacher/${teacherId}?month=${month}&year=${year}`);
            setData(res.data);
        } catch (err) {
    ...
    return (
        <>
            <Head>
                <title>Teacher Attendance Detail - Admin</title>
            </Head>
                ...
                <div className="space-y-6 pb-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">View individual teacher daily logs</p>
                        </div>
                    </div>
                    ...
                    {loading && !data ? (
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                <span className="text-sm text-gray-500 font-medium">Subjects: {data.subjects}</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center p-20 text-center">
                            ...
                            <p className="text-gray-500 mt-2">The requested teacher could not be located or you don't have access.</p>
