      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <h2 className="font-[var(--font-grotesk)] text-4xl md:text-5xl lg:text-6xl  text-gray-900 dark:text-white mb-6 leading-tight">
            Experience LearnXChain
          </h2>

          <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
            Join hundreds of schools already transforming their operations with
            AI-powered intelligence and blockchain-backed trust.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mb-12">
            ...
            >
              <Link
                href="/book-demo"
                className="relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#0057C8] to-[#1A9FFF] hover:from-[#0057C8] hover:to-[#1A9FFF] text-white font-semibold rounded-xl shadow-lg shadow-[#0057C8]/20 hover:shadow-xl transition-all duration-300 overflow-hidden group"
              >
                <motion.div
