...
export default function CourseReviewModal({ setReviewModal }: CourseReviewModalProps) {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      const response = await fetch("/api/course/createRating", {
        method: "POST",
          ...
          >
            ...
            <div className="flex w-11/12 flex-col space-y-2">
              ...
              <textarea
                ...
                className="form-style resize-none min-h-[130px] w-full bg-richblack-700 rounded-md p-3 text-richblack-5 outline-none focus:ring-2 focus:ring-yellow-50"
              />
