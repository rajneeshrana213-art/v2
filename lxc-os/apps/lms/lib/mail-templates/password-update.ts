export const passwordUpdated = (email: string, name: string) => {
    ...
    <body>
        <div class="container">
            <a href="https://learnxchain.com"><img class="logo" src="https://asset.cloudinary.com/dbn9fwzwk/cf216d996a90bc0f681e82290441f654" alt="LXC-LMS Logo"></a>
            ...
            <div class="support">If you have any questions or need further assistance, please feel free to reach out to us at <a href="mailto:info@studyhub.com">info@studyhub.com</a>. We are here to help!</div>
        </div>
    </body>
    </html>`;
};
